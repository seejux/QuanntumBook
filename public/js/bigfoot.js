  ...
  (function($) {
    return $.bigfoot = function(options) {      
      ...
      defaults = {
        ...
        contentMarkup: "<aside class=\"bigfoot-footnote is-positioned-bottom\" data-footnote-number=\"{{FOOTNOTENUM}}\" data-footnote-identifier=\"{{FOOTNOTEID}}\" alt=\"Footnote {{FOOTNOTENUM}}\"> <div class=\"bigfoot-footnote__wrapper\" style=\"width:400px\"> <div class=\"bigfoot-footnote__content\"> {{FOOTNOTECONTENT}} </div></div> <div class=\"bigfoot-footnote__tooltip\"></div> </aside>",
        buttonMarkup: "<div class='bigfoot-footnote__container'> <button class=\"bigfoot-footnote__button\" id=\"{{SUP:data-footnote-backlink-ref}}\" data-footnote-number=\"{{FOOTNOTENUM}}\" data-footnote-identifier=\"{{FOOTNOTEID}}\" alt=\"See Footnote {{FOOTNOTENUM}}\" rel=\"footnote\" data-bigfoot-footnote=\"{{FOOTNOTECONTENT}}\"> <svg class=\"bigfoot-footnote__button__circle\" viewbox=\"0 0 6 6\" preserveAspectRatio=\"xMinYMin\"><i class=\"fas fa-question questionMark-footnote\"></i></svg>  </button></div>"
      };
      ...
      clickButton = function($button) {
        ...
        if ($button.hasClass("changing")) {
          ...
          $button.find('.questionMark-footnote').css('color', '#f0f0f0'); //ddy
      ...
      removePopovers = function(footnotes, timeout) {
        ...
        $(footnotes).each(function() {
          ...
          if (!$linkedButton.hasClass("changing")) {
            ...
            $linkedButton.find('.questionMark-footnote').css('color', ''); //ddy
